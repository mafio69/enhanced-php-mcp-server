...
class ToolsController extends BaseController
{
    ...
    public function __construct(\App\Config\ServerConfig $config, \Psr\Log\LoggerInterface $logger, MCPServerHTTP $httpServer)
    {
    ...
    public function executeTool(Request $request, Response $response): Response
    {
        ...
        try {
            ...
            return $this->errorResponse($response, new \App\DTO\ErrorResponse(
